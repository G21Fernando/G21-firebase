...
const StatsCard: React.FC<StatsCardProps> = ({ practiceTime, points }) => {
  ...
  return (
    <div className="p-3 md:p-10">
      <h2 className="text-lg md:text-3xl font-bold text-[#1A1F2C] mb-2 md:mb-10">
        Your today stats:
      </h2>
      
      <div className="space-y-2 md:space-y-10">
        <div className="flex items-start gap-2 md:gap-4">
          <Clock className="w-4 md:w-7 h-4 md:h-7 text-[#1A1F2C] mt-1" />
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <span className="text-sm md:text-2xl font-medium text-[#1A1F2C]">Points: {points}</span>
