...
const LeaderboardCard: React.FC = () => {
  ...
  return (
    <div className="p-3 md:p-8 h-full flex flex-col justify-center">
      ...
      <ul className="space-y-1 md:space-y-4">
        {leaderboardData.map((player, index) => (
          <li 
            key={player.username}
            className="flex justify-between items-center p-1.5 md:p-4 bg-white/50 backdrop-blur-sm rounded-lg"
          >
