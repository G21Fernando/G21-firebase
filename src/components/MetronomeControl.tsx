...
const MetronomeControl: React.FC<MetronomeControlProps> = ({ onPointsUpdate, onPracticeTimeUpdate }) => {
  ...
  return (
    <div className="p-3 md:p-10 h-full flex flex-col justify-center">
      <Button 
        className="w-full mb-2 md:mb-10 bg-[#1A1F2C] hover:bg-[#2A2F3C] text-white text-base md:text-xl py-2 md:py-7 rounded-xl"
      ...
      {isPlaying && (
        <div className="text-center mt-2 md:mt-8 text-sm md:text-xl font-medium text-[#1A1F2C]">
